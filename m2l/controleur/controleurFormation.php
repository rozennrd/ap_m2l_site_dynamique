...
if (isset($_SESSION['identification'])) {
    ...
    $utilisateurEstResponsableForma = false; 
    if ($utilisateurActuel->getIdFonc() == "rf"){
        $utilisateurEstResponsableForma = true; 
    };
    // Voir les demandes de formation
    // Si on veut voir les demandes ET que l'utilisateur est un responsable de formation
    if (isset($_GET['voirDemandes'])&& $_GET['voirDemandes'] == 'true' && $utilisateurEstResponsableForma) {
        ...
        if(isset($_GET["id"]) && $_GET['id']) {
            ...
            if ($utilisateurEstResponsableForma) {
                // gestion de la suppression de la formation
            ...
            if ($utilisateurEstResponsableForma){
                ...
                var_dump(isset($_POST["submitAjoutForma"]));
                if (isset($_POST["submitAjoutForma"])){
